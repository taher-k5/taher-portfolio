...
const About = () => {
	return (
		<>
			...
			>
				I'm a skilled software developer with experience in Php, Python, TypeScript
				and JavaScript, and expertise in frameworks like Jquery, React, Three.js,
				Laravel, and Django. I'm a quick learner and collaborate closely with
